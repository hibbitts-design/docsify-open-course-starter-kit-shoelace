...
> This is a starter kit to create an open [Docsify](https://docsify.js.org) course site, using the [Shoelace](https://shoelace.style/) library of web components for the course reminders area.
